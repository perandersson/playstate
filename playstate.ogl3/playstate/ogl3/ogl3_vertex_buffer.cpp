...
OGL3VertexBuffer::OGL3VertexBuffer(PrimitiveType::Enum primitiveType, const VertexDeclaration& vertexDeclaration, GLuint bufferID, uint32 numVertices, uint32 vertexSize) 
...
void OGL3VertexBuffer::Render(uint32 startIndex, uint32 count) const
{
	...
	glDrawArrays(OGL3PrimitiveType[mPrimitiveType], startIndex, count);
}
...
PrimitiveType::Enum OGL3VertexBuffer::GetPrimitiveType() const
{
