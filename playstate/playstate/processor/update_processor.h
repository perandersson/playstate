...
namespace playstate
{
	...
	public:
		...
		//
		// @param updatable
		virtual void AttachUpdatable(Updatable* updatable) = 0;

		//
		// Detaches this updatable object from this processor. This disables it from receiving update events.
		//
		// @param updatable
		virtual void DetachUpdatable(Updatable* updatable) = 0;
		...
		//
		// @param tickable
		virtual void AttachTickable(Tickable* tickable) = 0;

		//
		// Detaches this tickable object from this processor. This disables it from receiving tick events.
		//
		// @param tickable
		virtual void DetachTickable(Tickable* tickable) = 0;
